# linguistik.computer Website

The https://linguistik.computer website is built using Jekyll, and uses the [**Millennial**](https://lenpaul.github.io/Millennial) Jekyll theme. This README is mostly copied from the Millennial README.

## Table of Contents

- [linguistik.computer Website](#linguistikcomputer-website)
...
Has been removed by the Heidelberg TaCoS group for increased privacy.
...
All icons are courtesy of [Font Awesome](https://fontawesome.com/), which the TaCoS Heidelberg team upgraded to version 7 (latest at the time of writing this). You can change which icons appear, as well as the account that they link to, in the `settings.yml` file in the `_data` folder.
